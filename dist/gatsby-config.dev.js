...
module.exports = {
  ...
  /************************** END MDX Plugins *********************************/
  "gatsby-remark-embed-video", "gatsby-remark-responsive-iframe", "gatsby-remark-reading-time", 'gatsby-plugin-eslint', "gatsby-plugin-styled-components", "babel-plugin-styled-components", //`gatsby-plugin-smoothscroll`,
  "gatsby-transformer-json", "gatsby-plugin-emotion", //`gatsby-plugin-twitter`,
  ...
  /***************** FLEXSEARCH ********************/
  {
    ...
    options: {
      languages: ['en'],
      type: 'Mdx',
      // Filter the node types you want to index
      // Fields to index.
      fields: [{
        name: 'id',
        indexed: false,
        // If indexed === true, the field will be indexed.
        resolver: 'id',
  ...
  // To learn more, visit: https://gatsby.dev/offline
  {
    ...
    options: {
      ...
      exclude: ["/404", /(\/)?hash-\S*/ // you can also pass valid RegExp to exclude internal tags for example
      ],
