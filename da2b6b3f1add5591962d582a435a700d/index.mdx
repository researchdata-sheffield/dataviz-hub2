...
thumbnail: ./temp.jpg
description: "(UPDATED on 01 Oct 2020) This article will guide you to setup a development environment, relevant steps for produce a blog post, and introduce 
...
# Introduction
(UPDATED on 01 Oct 2020) This is a template for blog posts. This website is built from <a href="https://www.gatsbyjs.org/">Gatsby</a> framework and the way of styling is slightly different from HTML/CSS. 
