...
<VisDiv>
  ...
  >
    ...
    <InfoDiv className="mt-12 md:mt-20 w-full flex space-x-8">
      <div>
        <h1>£20m</h1>
        <h3>project</h3>
      </div>
      ...
      <div style={{position: 'relative'}}>
        <span style={{color: 'rgb(156, 163, 175)', display: 'inline-block', textAlign: 'right', position: 'absolute', right: 0, top: 0, fontSize: '0.875rem', lineHeight: '1.25rem', marginTop: '-1rem'}}>
          by
        </span>
        <h1 style={{color: 'rgb(110, 231, 183)'}}>
          2030
        </h1>
        <h3>
