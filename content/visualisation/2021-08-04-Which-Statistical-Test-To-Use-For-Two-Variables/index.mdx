...
<div className="flex justify-center">
  <div style={{backgroundImage: `url(${Thumb})`, backgroundSize: 'cover', display: 'flex', justifyContent: 'center', alignItems: 'center', width: '500px', height: '500px', maxWidth: '100vw', backgroundPosition: 'center'}}>
    <ReactFlowProvider>
      <FlowChart />
    </ReactFlowProvider>
  </div>
