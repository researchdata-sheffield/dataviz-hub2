...
<div className="flex flex-wrap p-2 items-center">
  <div className="md:w-5/6 pr-6">
    <h3>Colin Angus recently demonstrated various visualisations that he had created for Covid-19 mortality on 
    <a href="https://twitter.com/VictimOfMaths/status/1254812649264680960"> Twitter</a>. Here he elaborates on his approach to this work.</h3>
  </div>
  <img src="./Colin_Angus.png" className="md:w-1/6" />
</div>

*CREDIT: This post was originally published by Neil Dymond-Green on the UK Data Service <a href="http://lab.ukdataservice.ac.uk/">Impact and Innovation Lab</a>.*
...
**<a href="https://www.sheffield.ac.uk/scharr/sections/heds/staff/angus_c">Colin Angus</a> (<a href="https://twitter.com/VictimOfMaths" >@VictimOfMaths</a>) is a Senior Research Fellow 
in the Sheffield Alcohol Research Group within <a href="https://www.sheffield.ac.uk/scharr">ScHARR</a>.**
