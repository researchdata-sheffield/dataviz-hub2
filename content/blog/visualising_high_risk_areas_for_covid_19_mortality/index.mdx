...
You can find the R code used to generate these maps and the other plots in this blog <a href="https://github.com/VictimOfMaths/COVID-19/blob/master/COVIDExposures.R" target="_blank" rel="noopener noreferrer">here</a>.
