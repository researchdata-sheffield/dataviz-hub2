...
<div className="flex flex-wrap p-2 items-center">
  <div className="flex flex-wrap w-full items-center">
    <div className="md:w-1/6 mx-auto">
      <img src="./Colin_Angus.png" className="rounded-lg" alt="Colin Angus thumbnail" style={{minHeight: '130px',"maxHeight": "145px"}}  />
    </div>
    <div className="md:w-5/6 p-2 lg:p-4">
      <div className="my-0 font-bold text-2xl flex items-center">
        Colin Angus
        <p className="inline-block ml-4">
          <a href="https://twitter.com/VictimOfMaths?ref_src=twsrc%5Etfw" class="twitter-follow-button" data-size="large" data-show-screen-name="false" data-dnt="true" data-show-count="false">Follow @VictimOfMaths</a>
        </p>
      </div>
