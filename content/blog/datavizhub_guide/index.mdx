  ...
  <div className="flex flex-wrap text-gray-900 mx-auto px-3 lg:px-16 2xl:px-16 py-8 lg:max-w-70 2xl:max-w-50 rounded-3xl" style={{backgroundColor: "rgba(255, 255, 255, .97)"}}>
    <Fade duration={2000} fraction={.5}>
      <div id="what" className="ipadp:min-h-80">
        <p className="text-blue-800 font-bold text-5xl">What is data visualisation?</p>
        <p>
    ...
    <div id="why" className="flex-wrap ipadp:min-h-80">
      <p className="text-blue-800 font-bold text-5xl">Why is it important?</p>
      <p>
    ...
    <div id="how" className="flex-wrap ipadp:min-h-80">
      <p className="text-blue-800 font-bold text-5xl">How this site could help?</p>
      <p>
        Support through: <br />
    ...
    <div id="start" className="flex-wrap ipadp:min-h-50">
      <p className="text-blue-800 font-bold text-5xl">Where should I start?</p>
      <p>
