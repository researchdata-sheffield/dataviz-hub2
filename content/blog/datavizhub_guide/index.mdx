...
<div className="flex flex-wrap justify-between px-3 md:px-32 lg:px-48 2xl:px-78 text-white bg-black text-sm  sticky top-0 left-0 relative z-10">
  <a href="#what" anchor className="text-white hover:text-highlight_2 cursor-pointer py-2">What is data visualisation</a>
  <a href="#why" anchor className="text-white hover:text-highlight_2 cursor-pointer py-2">Why is it important</a>
  <a href="#how" anchor className="text-white hover:text-highlight_2 cursor-pointer py-2">How this site could help</a>
  <a href="#start" anchor className="text-white hover:text-highlight_2 cursor-pointer py-2">Where should I start</a>
</div>

<div style={{backgroundImage: `url(${bg})`, backgroundSize: "cover", backgroundAttachment: "fixed"}} className="py-24">
  <div className="flex flex-wrap text-gray-700 mx-auto px-3 lg:px-16 2xl:px-16 py-8 lg:max-w-70 2xl:max-w-50" style={{backgroundColor: "rgba(255, 255, 255, 0.97)"}}>
