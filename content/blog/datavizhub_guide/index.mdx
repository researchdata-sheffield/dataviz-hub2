...
<div className="shadow-xl flex justify-center items-center text-center" style={{backgroundImage: `url(${bg})`, backgroundSize: "cover", backgroundAttachment: "fixed", width: "100%", flexDirection: "column", paddingTop: "35vh", paddingBottom: "35vh"}}>
