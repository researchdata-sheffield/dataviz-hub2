...
<div className="shadow-xl flex justify-center items-center text-center" style={{backgroundImage: `url(${bg})`, backgroundSize: "cover",  width: "100%", flexDirection: "column", paddingTop: "38vh", paddingBottom: "38vh"}}>
  <div >
...
<div className="flex flex-wrap justify-between px-3 md:px-32 lg:px-48 2xl:px-78 text-black bg-white text-sm sticky top-0 left-0 relative z-10 shadow-xl">
