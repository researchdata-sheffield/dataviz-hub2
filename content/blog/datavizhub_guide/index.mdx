...
<div className="shadow-xl flex justify-center items-center text-center py-40vh" style={{backgroundImage: `url(${bg})`, backgroundSize: "cover", backgroundAttachment: "fixed", width: "100%", flexDirection: "column"}}>
