...
<div className="flex flex-wrap text-gray-600">
  <Fade duration={2000}>
    <div id="what" className="flex-wrap ipadp:min-h-80 px-5 ipadp:px-12">
  ...
  <Fade duration={2000}>
  <div id="why" className="flex-wrap ipadp:min-h-100 px-5 ipadp:px-12">
  ...
  <Fade duration={2000}>
  <div id="how" className="flex-wrap ipadp:min-h-100 px-5 ipadp:px-12">
  ...
  <Fade duration={2000}>
  <div id="start" className="flex-wrap ipadp:min-h-100 px-5 ipadp:px-12">
