...
<div className="flex flex-wrap justify-between px-3 text-white bg-black text-sm">
  <a onClick={() => scroll_To('#what')} className="text-white hover:text-highlight_2 cursor-pointer py-2">What is data visualisation</a>
  <a onClick={() => scroll_To('#why')} className="text-white hover:text-highlight_2 cursor-pointer py-2">Why is it important</a>
  <a onClick={() => scroll_To('#how')} className="text-white hover:text-highlight_2 cursor-pointer py-2">How this site could help</a>
  <a onClick={() => scroll_To('#start')} className="text-white hover:text-highlight_2 cursor-pointer py-2">Where should I start</a>
</div>
