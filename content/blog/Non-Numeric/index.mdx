...
challenging to decipher when used as a scale therefore precise information will most likely not be extracted from the size of dot, instead, it provides a general impression.
If exact word length was crucial to my story, I may want to consider an alternative way of presenting it.
