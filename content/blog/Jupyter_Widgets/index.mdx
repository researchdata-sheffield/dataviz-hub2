...
# 1. Prerequsites
This documentation follows from <Link to="/blog/07/05/2020/dataviz_stats_2">'Plots with Python'</Link> and 
...
read <Link to="/blog/07/05/2020/dataviz_stats_2">Plot with Python</Link> (you'll find codes are coming from 
