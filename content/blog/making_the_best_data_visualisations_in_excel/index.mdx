...
## Some examples
This section presents some (good and bad) example charts made from Microsoft Excel 2016. Right click images then **view image** (Firefox) or **open in new tab** (Chrome) for full-size. 
...
If you think about moving from Excel to Python or R, get started on our [Learning Path](https://dataviz.shef.ac.uk/blog/03/07/2020/LearningPath_Introduction).