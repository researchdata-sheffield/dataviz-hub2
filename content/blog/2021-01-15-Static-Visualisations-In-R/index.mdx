...
# Other packages
In this section I'll briefly introduce some packages you can use as an alternative or in addition to *ggplot2*. If you have any suggestions or want me to include any particular package feel free to [send me an email](mailto:y.weng@sheffield.ac.uk).
