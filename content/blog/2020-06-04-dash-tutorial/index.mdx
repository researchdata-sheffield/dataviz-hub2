...
_[Dash](https://plot.ly/dash/) is a user interface library for creating analytical web applications. Those who use [Python](https://www.python.org) for data analysis, data exploration, visualization,
modelling, instrument control, and reporting will find immediate use for [Dash](https://plot.ly/dash/)._
...
Dash apps are composed of two parts: **Layout** and **Interactivity**.
