...
<iframe src="https://rawcdn.githack.com/yld-weng/hadfield-green-roof/main/part3/heatmap.html" style="width: 100%; min-height: 450px"></iframe>
...
If you already have some knowledge in R, then you can design your own app in a few hours by visiting [official video and written tutorials](https://shiny.rstudio.com/tutorial/). We also have some blog posts on Shiny for you to look at:  
...
Javascript visualisation libraries often have R wrappers we can make use for dynamic data visualisations in R. Most of the time you can mix and match libraries to suit your needs as each package were designed from a different perspective.


### Leaflet
**Leaflet** is one of most popular Javascript framework for (mobile-friendly) **interactive maps**. You can find its place not only in websites such as *GitHub*, *Facebook* and *The New York Times*, but also well known geographic information systems like *OpenStreetMap* and *Mapbox*. If you are looking for a package specialised in interactive maps then *[Leaflet for R](https://rstudio.github.io/leaflet/)* would not disappoint you.  

Packages also offers interactive maps:
...
<iframe src="https://rawcdn.githack.com/yld-weng/hadfield-green-roof/main/part3/timeSeries.html" style="width: 100%; min-height: 450px"></iframe>
*Click on legends to toggle lines*  

You can also embed charts within Shiny or R markdown document which makes this package a great alternative to *plotly*.


### r2d3
D3 stands for **Data-Driven Document** and D3.js is known as an open-source Javascript library that is capable of producing *web-based interactive data visualisations* in web browsers using SVG, HTML and CSS. It is powerful and customisable yet has a steep learning curve. If you are comfortable with D3 then you can use a range of toolsets provides by **[r2d3](https://github.com/rstudio/r2d3)**. For example, you can translate R objects into D3 data structures, render D3 scripts within RStudio and R markdown documents, and embed D3 visualisations directly inside Shiny.
...
### DT
The **DT** package provides a R wrapper to the Javascript library **[DataTables](https://rstudio.github.io/DT/)** which enables us to display matrices or data frames as HTML table with functions such as filtering, sorting and pagination. This package would be a great addition alongside visualisations you want to present to your audiences.  

<iframe src="https://rawcdn.githack.com/yld-weng/hadfield-green-roof/main/part3/datatable.html" style="width: 100%; min-height: 450px"></iframe>  
...
## ggiraph
The **ggiraph** extends from **ggplot2** and **htmlwidgets** and allows you to create interactive ggplot objects. Authors have set up a [website](https://davidgohel.github.io/ggiraph/index.html) with comprehensive documentations and many examples for beginners to get started. Go ahead and install this package if you enjoy working with *ggplot2* and comfortable with grammar of graphics.
