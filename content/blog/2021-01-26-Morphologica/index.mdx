...
*A plot of a reaction-diffusion simulation containing 2 state variables, n and c. This example contains a GraphVisual graph alongside the 3D surfaces, showing how some objects in the scene can be rotated while the 2D graph remains flat. (See [examples/Ermentrout2009/erm.cpp](https://github.com/ABRG-Models/morphologica/blob/main/examples/Ermentrout2009/erm.cpp))*
