...
In this documentation you will see the app that was built in **<Link to="/blog/12/06/2020/dash_tutorial_2">Dash tutorial</Link>** 
...
If you simply want share your Jupyter Notebook, find out options 
at **<Link to="/blog/24/06/2020/host_jupyter_notebook">Host Jupyter Notebook</Link>**. 

My codes for the app can be found [here](https://drive.google.com/file/d/1g88s6OeHMjdKpwfc4rREwTJhctiFCWsX/view?usp=sharing), 
