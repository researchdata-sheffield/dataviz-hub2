...
<div className="flex flex-wrap justify-between px-3 md:px-32 lg:px-48 2xl:px-78 text-black bg-white text-sm sticky top-0 left-0 relative z-10 shadow-md">
  <a href="#what" anchor className=" hover:text-highlight_2 cursor-pointer py-2" style={{background: 'none'}}>What is data visualisation</a>
  <a href="#why" anchor className=" hover:text-highlight_2 cursor-pointer py-2" style={{background: 'none'}}>Why is it important</a>
  <a href="#how" anchor className=" hover:text-highlight_2 cursor-pointer py-2" style={{background: 'none'}}>How this site could help</a>
  <a href="#start" anchor className=" hover:text-highlight_2 cursor-pointer py-2" style={{background: 'none'}}>Where should I start</a>
</div>
...
<div className="py-16">
  <div className="flex flex-wrap text-gray-900 mx-auto px-3 lg:px-16 2xl:px-16 py-8 lg:max-w-70 2xl:max-w-50 rounded-3xl" style={{backgroundColor: "rgba(255, 255, 255, .97)"}}>
    ...
    <div id="why" className="flex-wrap ipadp:min-h-80">
      ...
      than other methods, and it allow viewers to get more information.  <img style={{width: '100%'}} src="./img2.jpg" />
