...
## Next step
In this chapter we have seen different sampling methods and ways to describe samples. In the next chapter we will be looking at make statistical inference from samples using hypothesis testing.  
