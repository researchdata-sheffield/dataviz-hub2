...
thumbnail: ./temp.jpg
description: "(UPDATED on 21 Apr 2021) This article will guide you to setup a development environment, relevant steps for produce a blog post, and introduce 
...
If you do not want to setup the environment, you can write a post by upload **index.mdx** file and any resources related to the post on Github too. To do this,  
  ...
  2. Click the *Create new file* button on the top right, and type `folder-name/index.mdx` in the **name your file...** box, this will create a new directory with the name - `folder-name` 
