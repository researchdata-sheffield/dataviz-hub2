...
In part 6 we will be exploring the relationships between mean and variance for some distributions, solutions for data not satisfies the homogeneity of variance, and more on residuals.
