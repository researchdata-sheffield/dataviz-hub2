  ...
  <> 
    ...
    <div className="flex items-center justify-center text-center" style={{backgroundImage: `url(${Bg})`, minHeight: '650px'}}>
      <div className="text-white px-4" style={{fontFamily: "TUoS Blake"}}>
        ...
        <Link to="/search" >
        <button className="mt-16 mr-10 bg-gray-300 hover:bg-brand-blue text-center hover:text-white text-gray-700 font-semibold py-2 px-5 border border-transparent shadow">Try search</button>
        </Link>
      </div>
    </div>
  </>
