...
const menuTag = ({ pageContext }) => {
  ...
  return (
		<div className="w-full px-5 py-1 xl:py-2 text-gray-100 shadow-2xl text-sm xl:hidden relative z-10" style={{fontFamily: "TUoS Blake", backgroundColor: "rgba(0,0,0,0.80)"}}>
