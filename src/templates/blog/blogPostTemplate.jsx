  ...
  return (
    <div className="relative" key={mdx.id}>
      ...
      <div className="flex flex-wrap relative pt-10 mx-auto" style={{maxWidth: '1200px'}}>
        ...
        {/******** main mdx content  ***********/}
        <div className={` ${ tableOfContent && tableOfContent.items ? 'mdxBody' : ''} relative mx-auto container pt-0 pb-32 px-5 text-lg xl:text-xl`} style={{color: '#24292e', maxWidth: '700px'}}>
