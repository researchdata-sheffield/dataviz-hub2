...
import { H1, H2, H3, H4, H5, H6, P, A, Ol, Li, Hr, Del, Pre, Ul, BlockQuote, Link, IMGM, EM, Table, LPWrap, LPItem } from "../../components/style/blogPostStyle"
    ...
    <div className="justify-center mx-auto text-lg 2xl:text-xl">
      <MDXProvider 
        components={{ h1: H1, h2: H2, h3: H3, h4: H4, h5: H5, h6: H6, p: P, a: A, ol: Ol, li: Li, 
                      ...
                      img: IMGM, table: Table, LPWrap: LPWrap, LPItem: LPItem, Accordion: Accordion, 
