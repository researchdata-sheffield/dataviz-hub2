            ...
            <div key={node.id}>
              ...
              <a className="flex flex-wrap w-full overflow-hidden max-h-90 text-gray-700 group pb-2 px-2" style={{fontFamily: "TUoS Blake"}} href={node.url} target="_blank" rel="noopener noreferrer">
                <img 
                  ...
                  style={{objectFit: "cover", objectPosition: "center", minHeight: "180px"}} 
                />
                <div className="w-full md:w-9/12 pb-2 px-4">
                  ...
                  <div className="flex flex-wrap">
                    ...
                    <div className="flex flex-wrap w-full sm:w-full md:w-1/6 lg:w-1/6 xl:w-1/6 content-center justify-center hidden-xs hidden-md">
                      <button href={node.url} target="_blank" rel="noopener noreferrer" className="hidden group-hover:flex shadow-sm -mt-4 py-2 px-5 text-lg bg-gray-800 text-white hover:bg-brand-blue">
                        Register
                      </button>
                    </div>
                  </div>
