              ...
              <div key={node.id}>
                ...
                <a className="flex flex-wrap w-full overflow-hidden max-h-80 text-gray-700 group pb-2 px-2" style={{fontFamily: "TUoS Blake"}} href={node.url} target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="w-full md:w-9/12 pb-2 px-4">
                    ...
                    <p className="flex pt-2 group-hover:text-brand-blue text-sm xl:text-base"><FaClock className="mr-1" />{node.start.local}</p>
                    <div className="flex flex-wrap">
                      <div className="w-full sm:w-full md:w-5/6 lg:w-5/6 xl:w-5/6 text-sm xl:text-base">
                        <p className="flex group-hover:text-brand-blue">{node.online_event && (<FaMapMarkerAlt className="mr-1 mt-1" />)} {node.online_event && ("Online Event") }</p>
                        <p className="flex group-hover:text-brand-blue">
