...
const PastEventsBlog = ({pastEventBlog}) => {
  ...
  return (
    <div className="w-full md:w-11/12 2xl:w-10/12 px-6 lg:mt-6 lg:mb-16 pb-8 lg:py-6 border-t-4 border-gray-800 min-h-50 rounded-3xl" style={{background: "rgba(255,255,255,.9)", }}>
