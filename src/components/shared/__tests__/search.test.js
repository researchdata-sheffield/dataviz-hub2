...
const mockResult = [
  ...
  },
  {
    ...
    "description": "An interative tool based on the flow chart made by Jean Russell to help you determine which statistical test to use for two variables. This tool is a part of the statistical modelling learning path.\n",
    "author": [
      "Yu Liang Weng"
    ],
    "category": [
...
describe("Search component", () => {
  ...
  beforeEach(() => {
    ...
    spy = jest.spyOn(Search.prototype, 'getSearchResults').mockImplementation((query) => {
      if (!query) {
        return []
      }
      return mockResult;
                      ...
                      "gatsbyImageData": {
                        ...
                        "images": {
                          "fallback": {
                            ...
                            "srcSet": "/static/550fb0c7cd27123c708c78a607e115b6/52cc1/thumb.png 580w",
                            "sizes": "100vw"
                          },
                          "sources": [
                            {
                              "srcSet": "/static/550fb0c7cd27123c708c78a607e115b6/f8c58/thumb.webp 580w",
                              "type": "image/webp",
                              "sizes": "100vw"
                            }
                          ]
  ...
  it("return search result without error", async () => {
    ...
    const inputNode = screen.getByPlaceholderText('Search title, description, date...')
    
    await fireEvent.change(inputNode, {target: {value: 'test search query'}});
