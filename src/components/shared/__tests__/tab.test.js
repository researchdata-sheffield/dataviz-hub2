...
describe("tab component", () => {
  ...
  it("should renders correctly", async() => {
    ...
    await waitFor(() => {
      expect(document.querySelector("#react-tabs-1")).toHaveClass('react-tabs__tab-panel--selected');
      expect(document.querySelector("#react-tabs-3")).not.toHaveClass('react-tabs__tab-panel--selected');
      expect(document.querySelector("#react-tabs-5")).not.toHaveClass('react-tabs__tab-panel--selected');
    })
  })
