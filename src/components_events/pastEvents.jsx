...
const PastEvents = ({pastEvent}) => {
  ...
  return (
    <div className="w-full md:w-4/5 lg:w-4/12 2xl:w-3/12 lg:rounded-r-3xl md:mt-10 lg:mt-0 p-6 text-gray-100 border-t-8 border-gray-800 min-h-50" style={{background: "rgba(0,0,0,.8)", }}>
