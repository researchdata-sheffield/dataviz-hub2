...
const HomeShowcase = () => {
  ...
  return (
    <div className="relative overflow-x-hidden bg-gray-800 relative">
      ...
      <div className="ipadp:min-h-40 flex flex-wrap pt-6 ipadp:pt-12 pb-64 items-center justify-center bg-gray-100">
